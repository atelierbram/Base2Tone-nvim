...
local c = require('base2tone_drawbridge_dark.palette')
...
theme.set_highlights = function()
  ...
  hl(0, "DiffAdded", { fg = c.B2T_B2, bg = c.B2T_A0 })
  hl(0, "DiffFile", { fg = c.B2T_B0, bg = c.B2T_A0 })
  ...
  hl(0, "cssProp", { fg = c.B2T_B2, bg = 'NONE' })
  ...
  hl(0, "WhichKeySeperator", { fg = c.B2T_B2, bg = 'NONE' })
  ...
  hl(0, "GitSignsAdd", { fg = c.B2T_B0, bg = 'NONE' })
