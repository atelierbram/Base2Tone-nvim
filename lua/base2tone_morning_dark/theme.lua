...
local c = require('base2tone_morning_dark.palette')
...
theme.set_highlights = function()
  ...
  hl(0, "NormalFloat", { fg = c.B2T_B5, bg = c.B2T_A1,  })
  ...
  hl(0, "LineNr", { fg = c.B2T_A2, bg = c.B2T_A1 })
  hl(0, "CursorLineNr", { fg = c.B2T_A3, bg = c.B2T_A1 })
  hl(0, "MatchParen", { fg = c.B2T_A7, bg = c.B2T_A2 })
  hl(0, "ModeMsg", { fg = c.B2T_B6, bg = 'NONE' })
  hl(0, "MoreMsg", { fg = c.B2T_B6, bg = 'NONE' })
  hl(0, "NonText", { fg = c.B2T_A3, bg = 'NONE' })
  hl(0, "Pmenu", { fg = c.B2T_A3, bg = c.B2T_A1 })
  hl(0, "PmenuSel", { fg = c.B2T_D0, bg = c.B2T_C2 })
  hl(0, "PmenuSbar", { fg = c.B2T_A1, bg = c.B2T_A1 })
  hl(0, "PmenuThumb", { fg = c.B2T_D5, bg = c.B2T_A1 })
  hl(0, "Question", { fg = c.B2T_D5, bg = 'NONE' })
  hl(0, "QuickFixLine", { fg = c.B2T_B5, bg = 'NONE' })
  hl(0, "Search", { fg = c.B2T_A3, bg = c.B2T_D4 })
  hl(0, "IncSearch", { fg = c.B2T_A1, bg = c.B2T_D2 })
  hl(0, "SpecialKey", { fg = c.B2T_A3, bg = 'NONE' })
  hl(0, "SpellBad", { fg = c.B2T_B5, bg = c.B2T_A0, underline=true, })
  hl(0, "SpellCap", { fg = c.B2T_D5, bg = c.B2T_A0 })
  ...
  hl(0, "Visual", { fg = 'NONE', bg = c.B2T_A1 })
  hl(0, "VisualNOS", { fg = c.B2T_B5, bg = 'NONE' })
  hl(0, "WarningMsg", { fg = c.B2T_B5, bg = 'NONE' })
  ...
  hl(0, "Character", { fg = c.B2T_B5, bg = 'NONE' })
  ...
  hl(0, "Debug", { fg = c.B2T_B5, bg = 'NONE' })
  hl(0, "Error", { fg = c.B2T_A0, bg = c.B2T_D4 })
  hl(0, "Todo", { fg = c.B2T_A1, bg = c.B2T_B0 })
  hl(0, "debugPC", { fg = c.B2T_A1, bg = c.B2T_B6 })
  hl(0, "debugBreakpoint", { fg = c.B2T_A1, bg = c.B2T_B0 })
  hl(0, "healthError", { fg = c.B2T_B5, bg = 'NONE' })
  hl(0, "healthSuccess", { fg = c.B2T_D5, bg = 'NONE' })
  hl(0, "healthWarning", { fg = c.B2T_B6, bg = 'NONE' })

  -- LSP
  hl(0, "DiagnosticHint", { fg = c.B2T_A7, bg = 'NONE' })
  hl(0, "DiagnosticInfo", { fg = c.B2T_C5, bg = 'NONE' })
  hl(0, "DiagnosticWarn", { fg = c.B2T_C5, bg = 'NONE' })
  hl(0, "DiagnosticError", { fg = c.B2T_D4, bg = 'NONE' })
  hl(0, "DiagnosticOther", { fg = c.B2T_D4, bg = 'NONE' })
  ...
  hl(0, "DiagnosticVirtualTextHint", { fg = c.B2T_A7, bg = c.B2T_A0 })
  hl(0, "DiagnosticVirtualTextInfo", { fg = c.B2T_C5, bg = c.B2T_A0 })
  hl(0, "DiagnosticVirtualTextWarn", { fg = c.B2T_C5, bg = c.B2T_A0 })
  hl(0, "DiagnosticVirtualTextError", { fg = c.B2T_D4, bg = c.B2T_A0 })
  hl(0, "LspDiagnosticsError", { fg = c.B2T_D4, bg = 'NONE' })
  hl(0, "LspDiagnosticsWarning", { fg = c.B2T_C5, bg = 'NONE' })
  hl(0, "LspDiagnosticsInfo", { fg = c.B2T_C5, bg = 'NONE' })
  ...
  hl(0, "TSWarning", { fg = c.B2T_B5, bg = 'NONE' })
  hl(0, "TSDanger", { fg = c.B2T_B5, bg = 'NONE' })
  ...
  hl(0, "TSProperty", { fg = c.B2T_D4, bg = 'NONE' })
  ...
  hl(0, "TSText", { fg = c.B2T_C6, bg = 'NONE' })
  ...
  hl(0, "markdownHeadingDelimiter", { fg = c.B2T_A2, bg = 'NONE' })
  hl(0, "markdownHeadingRule", { fg = c.B2T_A2, bg = 'NONE', bold=true, })
  hl(0, "markdownId", { link = 'Indentifier' })
  hl(0, "markdownIdDeclaration", { fg = c.B2T_A0, bg = 'NONE' })
  ...
  hl(0, "markdownLink", { fg = c.B2T_D2, bg = 'NONE' })
  hl(0, "markdownLinkText", { fg = c.B2T_B6, bg = 'NONE' })
  hl(0, "markdownListMarker", { fg = c.B2T_D4, bg = 'NONE' })
  hl(0, "markdownOrderedListMarker", { fg = c.B2T_D4, bg = 'NONE' })
  ...
  hl(0, "cssInclude", { fg = c.B2T_B4, bg = 'NONE' })
  ...
  hl(0, "cssProp", { fg = c.B2T_B6, bg = 'NONE' })
  ...
  hl(0, "cssUnitDecorators", { fg = c.B2T_D4, bg = 'NONE' })
  ...
  hl(0, "sassInclude", { fg = c.B2T_B4, bg = 'NONE' })
  hl(0, "sassMedia", { fg = c.B2T_A5, bg = 'NONE' })
  hl(0, "sassMixing", { fg = c.B2T_B4, bg = 'NONE' })
  hl(0, "sassMixin", { fg = c.B2T_B4, bg = 'NONE' })
  hl(0, "sassMixinName", { fg = c.B2T_D4, bg = 'NONE' })
  hl(0, "sassProperty", { fg = c.B2T_B6, bg = 'NONE' })
  hl(0, "sassDefinition", { fg = c.B2T_B4, bg = 'NONE' })
  ...
  hl(0, "TelescopeMatching", { fg = c.B2T_B6, bg = 'NONE', bold=true, })
  ...
  hl(0, "packerRelDate", { fg = c.B2T_A2, bg = 'NONE' })
  ...
  -- Notify
  hl(0, "NotifyERRORBorder", { fg = c.B2T_B5, bg = 'NONE' })
  hl(0, "NotifyWARNBorder", { fg = c.B2T_B5, bg = 'NONE' })
  hl(0, "NotifyINFOBorder", { fg = c.B2T_B5, bg = 'NONE' })
  ...
  hl(0, "NavicIconsMethod", { fg = c.B2T_B5, bg = 'NONE' })
  ...
  hl(0, "NavicIconsFunction", { fg = c.B2T_B5, bg = 'NONE' })
  ...
  -- IndentBlankline
  hl(0, "IndentBlanklineContextChar", { fg = c.B2T_A1, bg = 'NONE',  })
  ...
  hl(0, "NvimTreeNormal", { fg = c.B2T_B6, bg = c.B2T_A0,  })
  ...
  hl(0, "NvimTreeImageFile", { fg = c.B2T_A2, bg = 'NONE' })
  hl(0, "NvimTreeSpecialFile", { fg = c.B2T_C5, bg = 'NONE' })
  ...
  hl(0, "NvimTreeSymlink", { fg = c.B2T_B5, bg = 'NONE' })
